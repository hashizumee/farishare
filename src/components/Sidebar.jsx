...
export default function Sidebar({
  ...
  return (
    <div className="fixed inset-0 z-50 flex">
      ...
      {/* Drawer Panel */}
      <aside className="relative w-80 max-w-[85vw] bg-slate-950 border-r border-slate-800 h-full shadow-2xl z-10 animate-slide-in flex flex-col justify-between p-5">
        ...
        <div className="space-y-3 pt-4 border-t border-slate-800/80">
          ...
          <button
            ...
            className="w-full flex items-center gap-2.5 p-3 rounded-2xl bg-slate-900 hover:bg-rose-500/10 border border-slate-800 hover:border-rose-500/30 text-slate-400 hover:text-rose-400 transition-all text-xs font-bold"
          >
          ...
          <div className="p-3 rounded-xl bg-slate-950 border border-slate-800/80 flex items-center gap-2">
            ...
            <div className="text-[10px] text-slate-400">
              <span className="font-bold text-slate-300">Auto-Save HP Aktif</span>
              <div>Penyimpanan lokal browser</div>
            </div>
          </div>
